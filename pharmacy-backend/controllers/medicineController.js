...
export const getAll = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Server Error. Unable to Fetch all Medicines" });
  }
};
...
export const lowStock = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Server Error. Unable to fetch Low Stock Medicines." });
  }
};
...
export const expired = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Server Error. Unable to fetch Expired Medicines." });
  }
};
